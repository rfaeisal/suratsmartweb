...
import MonthlyRecapClient from "./MonthlyRecapClient"
...
export default async function MonthlyRecapPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Rekap Absensi Bulanan</h2>
        <p className="text-sm text-gray-500 mt-1">
          Ringkasan kehadiran per pegawai untuk satu bulan penuh — hari kerja, hadir, telat, dan persentase kehadiran.
        </p>
      </div>
      <MonthlyRecapClient units={units} lockedUnitId={lockedUnitId} />
    </div>
  )
}
