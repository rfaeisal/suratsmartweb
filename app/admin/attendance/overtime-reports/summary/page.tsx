...
import OvertimeSummaryClient from "./OvertimeSummaryClient"

export const dynamic = "force-dynamic"

export default async function OvertimeSummaryPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Laporan Lembur — Ringkasan</h2>
        <p className="text-sm text-gray-500 mt-1">Ringkasan per pegawai: jumlah pengajuan, status, dan total durasi.</p>
      </div>
      <OvertimeSummaryClient units={units} lockedUnitId={lockedUnitId} />
    </div>
  )
}
