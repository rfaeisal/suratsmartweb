  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Unduh laporan kehadiran pegawai per periode dalam format Excel atau PDF.</p>
      </div>
      <AttendanceReportsClient units={units} lockedUnitId={lockedUnitId} />
    </div>
  )
}
