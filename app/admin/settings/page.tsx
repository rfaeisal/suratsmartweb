    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          {/* Numeric inputs */}
          {settings.filter((s) => s.type === "number").length > 0 && (
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 divide-y divide-gray-100 dark:divide-slate-700">
                  ...
                  <div key={setting.key} className="flex items-start gap-4 px-5 py-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0 pt-0.5">
                      <input
                        ...
                        disabled={isSaving}
                        className="w-20 px-2 py-1 text-sm text-center border border-gray-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                      />
                      <button
